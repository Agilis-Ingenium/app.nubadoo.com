    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
                ...
                <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Uh-oh! It looks like you've stumbled upon uncharted territory. We couldn't find the page you were looking for.  Fear not! Our team of digital explorers is on the case, mapping out new paths as we speak. </p>
